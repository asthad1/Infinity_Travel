...
// Import images from src/assets/images/rentals
// Import images from src/assets/images/rentals
import bmwImage from '../assets/images/rentals/BMW.jpg';
import chevyImage from '../assets/images/rentals/Chevy-tahoe.jpg'; // Adjusted filename if necessary
import ferrariImage from '../assets/images/rentals/Ferrari.jpg';
import fordEscapeImage from '../assets/images/rentals/Ford-escpae.jpg'; // Adjusted filename if necessary
import hondaCivicImage from '../assets/images/rentals/Honda-civic.jpg'; // Adjusted filename if necessary
...
import toyotaImage from '../assets/images/rentals/toyota.jpg' // Adjusted filename if necessary
            ...
            {searchResults.map((rental) => (
              <div key={rental.id} className="col-md-4">
                <div className="card rental-card shadow-sm">
                  <img
                    src={imageMap[rental.name]}  // Get image based on rental name
                    alt={rental.name}
        ...
        <Modal.Body>
          {selectedRental && (
            <>
              ...
              <p>Total Price: ${(new Date(dropOffDate) - new Date(pickupDate)) / (1000 * 60 * 60 * 24) * selectedRental.price_per_day}</p>
